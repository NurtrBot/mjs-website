    ...
    <div className="flex-shrink-0 w-[190px] bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-[0_0_12px_rgba(0,0,0,0.1)] transition-all group relative">
      ...
      <div className="p-3">
        ...
        <div className="flex items-center gap-1.5 mt-2.5">
          ...
          <button
            onClick={() => { const tp = getTierPrice(product, qty); addItem({ slug: product.slug, sku: product.sku, name: product.cardTitle, brand: product.brand, price: tp, image: product.images[0], pack: product.pack }, qty); trackAddToCart({ sku: product.sku, name: product.cardTitle, price: tp, quantity: qty, brand: product.brand }); setQty(1); }}
...
export default function ReadyToShipAlt() {
  ...
  return (
    <section className="hidden md:block bg-white py-6 border-t border-gray-100">
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <a href="/collection?type=ready-to-ship" className="text-xs font-semibold text-mjs-red hover:text-mjs-red-dark transition-colors mr-2">View All &rarr;</a>
